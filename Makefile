...
dependencies:
	docker run -w/go/src/github.com/firehydrant/api-client-go -v $(shell pwd):/go/src/github.com/firehydrant/api-client-go golang:$(GO_VERSION) sh -c 'apk add git && go get ./...'
